                  ...
                  <div key={m.id} className={`flex flex-col ${propio ? "items-end" : "items-start"}`}>
                    ...
                    >
                      {m.attachment_url && m.attachment_type === "image" && (
                        <a href={m.attachment_url} target="_blank" rel="noreferrer" className="block">
                          ...
                          <img
                            ...
                            alt={m.attachment_name ?? "imagen adjunta"}
                            style={{ maxWidth: "220px", maxHeight: "220px", borderRadius: "0.5rem", display: "block", marginBottom: m.body ? "0.4rem" : 0 }}
                          />
                        </a>
                      )}
                      {m.attachment_url && m.attachment_type === "file" && (
                          ...
                          style={{ marginBottom: m.body ? "0.4rem" : 0 }}
                        >
                          📎 {m.attachment_name}
                        </a>
                      )}
