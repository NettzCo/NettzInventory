...
import { traerInventarioCompleto, traerTodasLasFilas } from "@/lib/simQueries";
...
export default async function InicioPage() {
  ...
  const [sims, clientesActivosRes, totalClientesRes, activacionesRecientes, vistas] = await Promise.all([
    ...
    // Paginado explícitamente: este conteo ya venía mostrando 988 de un tope
    // silencioso de 1000 filas — a un paso de truncarse sin ningún aviso.
    traerTodasLasFilas<{ sim_id: string }>((d, h) =>
      supabase
