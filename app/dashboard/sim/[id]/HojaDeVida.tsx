...
import { cambiarEstado, asignarNumeroCorto, reasignarCliente, actualizarDetalles, renovarSim, desactivarSim, ReasignacionInput } from "./actions";
    ...
    <PanelWrapper title="Reasignar número corto" onClose={onClose}>
      <div className="flex flex-col gap-3 max-w-md">
        ...
        <p className="text-xs" style={{ color: "var(--text-muted)" }}>
          Si el número ya está en otra SIM, solo se puede tomar si esa SIM está &quot;Desactivada&quot;.
        </p>
        {error && <p className="text-sm" style={{ color: "var(--state-desactivada)" }}>{error}</p>}
        <button
          disabled={isPending}
