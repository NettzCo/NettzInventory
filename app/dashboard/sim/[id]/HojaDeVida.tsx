...
import { formatFecha, formatFechaHora, formatMoneda, estadoEfectivo } from "@/lib/ui";
...
export default function HojaDeVida({
  ...
  // una fecha de activación separada) más la duración del plan.
  const fechaVencimiento =
    current?.tipo_plan === "Prepago" && current?.fecha_entrega
      ? addMonths(new Date(`${current.fecha_entrega}T00:00:00`), current.duracion_meses ?? 12)
      : null;
