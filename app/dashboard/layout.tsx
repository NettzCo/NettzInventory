...
export default async function DashboardLayout({
  ...
  const alertCount = contarAlertasActivas(sims, vistas) + alertasPedidos.length; // el chat NO cuenta aquí
  const chatCount = alertasChat.reduce((total, a) => total + a.cantidad, 0);
