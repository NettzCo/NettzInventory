...
import { traerInventarioCompleto } from "@/lib/simQueries";
...
export default async function AlertasPage({
  ...
  const [sims, alertasChat, alertasPedidos, vistas] = await Promise.all([
    traerInventarioCompleto(supabase),
  ...
  // Mismo problema que había en Inventario: escanear sim_cards sin límite
  // se corta en silencio a 1000 filas — con miles de SIMs de Claro
  // ordenadas alfabéticamente, los demás proveedores nunca aparecían.
  ...
  const alertas = calcularAlertas(sims, vistas, {
