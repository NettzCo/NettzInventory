          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              <span
                ...
                style={{ background: a.esGeneral ? "var(--chip-gold)" : a.esGrupo ? "var(--chip-gold)" : "var(--state-lista)" }}
              />
              <div className="min-w-0">
                <p className="text-sm font-medium">
                  {a.esGeneral ? "Canal general" : a.esGrupo ? `Grupo: ${a.nombreOtro}` : `Mensaje directo de ${a.nombreOtro}`}
                </p>
