...
export default function ClientesManager({ clientes }: { clientes: Cliente[] }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <form action="/dashboard/clientes/exportar" method="get" className="flex flex-wrap items-end justify-end gap-3">
        <div>
        ...
        <div>
          <label className="text-xs font-medium block mb-1" style={{ color: "var(--text-secondary)" }}>Registrados desde</label>
      ...
      <tr className="border-b last:border-0 align-top" style={{ borderColor: "var(--border)" }}>
        <td colSpan={9} className="px-6 py-4" style={{ background: "var(--bg)" }}>
          ...
          <div className="flex gap-3 mt-3">
            ...
            <button onClick={cancelar} disabled={isPending} className="rounded-lg border px-4 py-2 text-sm font-medium hover:underline cursor-pointer" style={{ borderColor: "var(--border)" }}>
              Cancelar
            </button>
          </div>
        </td>
    ...
    <tr className="border-b last:border-0 align-top" style={{ borderColor: "var(--border)" }}>
      ...
      <td className="px-6 py-3">
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setEditando(true)} className="text-xs hover:underline cursor-pointer" style={{ color: "var(--text-secondary)" }}>Editar</button>
        </div>
      </td>
