      ...
      <div className="flex items-start justify-between mb-2">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>
            SIM prepago que cumplen (o ya cumplieron) 1 año desde su última activación.
          </p>
        </div>
        <a
          href={`/dashboard/alertas/exportar?${queryExport.toString()}`}
        ...
        <>
          {vencidas.length > 0 && (
            <div className="rounded-lg px-4 py-2.5 text-sm mb-4" style={{ background: "#FDEAEA", color: "var(--state-desactivada)" }}>
              {vencidas.length} SIM ya cumplieron 1 año desde su última activación.
            </div>
          )}
